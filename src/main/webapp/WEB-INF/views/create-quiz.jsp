      ...
      <div class="row test">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6 pb-5">
              <form id="createQuiz" action="/create-new-quiz" method="POST">
                <input name="isPublic" style="display: none;" value="public" readonly />
                <h5 style="text-align: center;">Create a Quiz</h5>
                <div class="card">
                  <div class="card-body p-3">
                    ...
                    <div class="form-group">
                      <div class="input-group mb-2">
                        <input type="number" class="form-control" placeholder="Number of Questions"
          ...
          <div class="card" style="width: 18rem; margin: auto;">
            <div class="card-body">
              <h5 class="card-title">Looking to set a quiz to a class?</h5>
              <p class="card-text" style="height: 0px; margin-bottom: 50px;">Go to the class's teacher page</p>
              <a href="/view-classes" class="btn btn-primary">Your Classes</a>
            </div> 
          </div>
        </div>
      </div>
