...
<body>
  <div id="wrapper">
    ...
    <div class="container">
      <div class="row test">
        <div class="col-sm left-col overflow-auto">
          <h3>Student Classes</h3>
          <ul class="list-group">
            <c:forEach items="${studentClasses}" var="studentClasses">
              <a href="/student-class/${studentClasses.getId()}">
                <li style="margin-top: 1%;" class="list-group-item"> <span style="float: left;"><i
                      class="material-icons">class</i></span> ${studentClasses.getName()}</li>
              </a>
            </c:forEach>
          </ul>
        </div>
        <div class="col-sm right-col overflow-auto">
          <h3>Taught Classes</h3>
          <ul class="list-group">
            <c:forEach items="${AllClasses}" var="allclasses">
              <a href="/teacher-class/${allclasses.getId()}">
                <li style="margin-top: 1%;" class="list-group-item"> <span style="float: left;"><i
                      class="material-icons">class</i></span> ${allclasses.getName()}</li>
              </a>
            </c:forEach>
          </ul>
        </div>
