...
import jp487bluebook.app.controller.QuizController;
...
@SpringBootTest(classes={QuizController.class, TestSecurityConfig.class, WebConfig.class, HashMap.class})
...
public class QuizControllerTests {
    ...
    public void profilePageMappings() throws Exception {
		//all quizzes
		mockMvc.perform(
            MockMvcRequestBuilders.get("/all-quizzes")

		)
		.andExpect(MockMvcResultMatchers.view().name("all-quizzes"))
